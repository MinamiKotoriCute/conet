...
TEST(ResultTest, ConstructorDefault)
{
    ...
    conet::result<NoDefaultConstructor> r4;
}
...
TEST(ResultTest, ConstructorAcceptsErrorCode)
{
    ...
    EXPECT_EQ(r1.error_info().error_code(), boost::system::error_condition(1, conet::error::conet_category()));

    // build-in type
    conet::result<int> r2(ec);
    EXPECT_EQ(r2.error_info().error_code(), boost::system::error_condition(1, conet::error::conet_category()));
    
    // move-only
    conet::result<std::unique_ptr<int>> r3(ec);
    EXPECT_EQ(r3.error_info().error_code(), boost::system::error_condition(1, conet::error::conet_category()));
}
...
TEST(ResultTest, ConstructorCopyCheckErrorCode)
{
    ...
    conet::result<void> a2(a1);
    EXPECT_EQ(a2.error_info().error_code(), boost::system::error_condition(1, conet::error::conet_category()));
    conet::result<int> b2(b1);
    EXPECT_EQ(b2.error_info().error_code(), boost::system::error_condition(1, conet::error::conet_category()));
    // conet::result<std::unique_ptr<int>> c2(c1); // std::unique_ptr<int> is move-only type. so c1 is move-only type too.
    ...
    // difference type
    conet::result<void> a3(b1);
    EXPECT_EQ(a3.error_info().error_code(), boost::system::error_condition(1, conet::error::conet_category()));
    conet::result<void> a4(c1);
    EXPECT_EQ(a4.error_info().error_code(), boost::system::error_condition(1, conet::error::conet_category()));
    conet::result<int> b3(a1);
    EXPECT_EQ(b3.error_info().error_code(), boost::system::error_condition(1, conet::error::conet_category()));
    conet::result<int> b4(c1);
    EXPECT_EQ(b4.error_info().error_code(), boost::system::error_condition(1, conet::error::conet_category()));
    conet::result<std::unique_ptr<int>> c3(a1);
    EXPECT_EQ(c3.error_info().error_code(), boost::system::error_condition(1, conet::error::conet_category()));
    conet::result<std::unique_ptr<int>> c4(b1);
    EXPECT_EQ(c4.error_info().error_code(), boost::system::error_condition(1, conet::error::conet_category()));
}
